...
class ReadOnlyHostDiagnosticTests(unittest.TestCase):
    ...
    def repo_request(self):
        return ReadOnlyDiagnosticRequestV1.from_mapping({"schema_version": REQUEST_SCHEMA, "request_id": "REQ-GIT", "operation": "repo.snapshot", "root_id": "project", "relative_path": "", "start_line": 0, "line_count": 0, "service_id": ""})
    def service_request(self, service_id="ocpv2.service"):
        return ReadOnlyDiagnosticRequestV1.from_mapping({"schema_version": REQUEST_SCHEMA, "request_id": "REQ-SVC", "operation": "user_service.properties", "root_id": "", "relative_path": "", "start_line": 0, "line_count": 0, "service_id": service_id})
    ...
    def test_repo_snapshot_uses_fixed_shell_false_git_environment(self):
        ...
        self.assertEqual((snapshot["branch"], snapshot["ahead"], snapshot["behind"]), ("main", 1, 2))
