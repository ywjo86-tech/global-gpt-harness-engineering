...
class RemoteOperatorService:
    def __init__(
        ...
        *,
        ...
        decode_envelope: Callable[[RawControlEnvelope], RemoteControlEnvelope],
        ...
        after_projection_published: Callable[
            [RemoteControlEnvelope, Mapping[str, Any]], None
        ] | None = None,
    ) -> None:
                ...
                if directive.state_change_required:
                    ...
                    if self.execute_read_only is None:
                        ...
                        projection = self._projection(
                            envelope, "READ_ONLY_DIAGNOSTIC_COMPLETED", detail=result
                        )
                        diagnosed += 1
                else:
