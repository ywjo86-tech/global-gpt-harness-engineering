...
class OrchestrationEngine:
    ...
    def _pre_mprf_eligibility_snapshot(self, run_id: str) -> ProviderEligibilitySnapshotV1:
        # Pre-MPRF governed HYBRID consumes the already-approved static NVIDIA
        # model-pool policy. NVIDIA_MODEL remains a standalone legacy adapter
        # setting and is deliberately not authoritative here.
        pool_path = Path(
